...
public class MovieInformationController {
    ...
    public ResponseEntity<MovieUpdateResponse> updateMovie(@PathVariable("id") @RequestBody @Valid MovieUpdateForm movieUpdateForm) {
        movieInformationService.updateMovie(movieUpdateForm.convertToMovie());
